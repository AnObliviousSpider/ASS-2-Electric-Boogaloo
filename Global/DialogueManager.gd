...
var dialogue_levels: Dictionary = {
	...
	2: [
		{"align": "left", "text": "There aren’t that many planets left"},
		{"align": "right", "text": "I could start fishing for more in some black holes? Fun date idea right?!"},
		{"align": "left", "text": "Come on, there’s got to be some way to keep this going… Right?"},
		{"align": "right", "text": "I could try cutting the planets in two… Wait no then they wouldn’t work as balls."},
		{"align": "left", "text": "Well we still haven’t been kicked out of the arcade yet? One more game?"},
	],
	3: [
...
"},
		...
		{"align": "right", "text": "BECAUSE EVERYTHING WOULD END RIGHT NOW AND I DON'T WANT US TO END!"},
		{"align": "left", "text": "... Oh, I see."},
	],
	4: [
		{"align": "left", "text": "Please…. don’t let this end…"},
		{"align": "right", "text": "Look, We both know I have to fulfill my purpose eventully….."},
		{"align": "left", "text": "There’s nothing left after this"},
		{"align": "right", "text": "No matter what happens, I’ll always hold you in my hearts"},
		{"align": "left", "text": "If you are remembered, you are never dead. I guess I'll be eternal within you."},
	],
	5: [
		{"align": "right", "text": "Thank you for winning…"},
		{"align": "left", "text": "So that was it then?"},
		{"align": "right", "text": "That was it. I guess we’ll just have to play again tomorrow."},
...
var dialogue_moods: Dictionary = {
	"Happy": [
		...
		"The universe may have been made last Thursday, and you wouldn’t know any better.",
		"The day you will fulfill your destiny is soon. That day is pancake day! Please can we get pancakes next?",
		"Don’t worry about it! Things break all the time. Like planets, stars and stuff.",
		"Again, Again!",
	],
	"Flirty": [
		"You made me think of another game we can play later",
		"I’m surprised you can last this many rounds against me",
		"This game is fun. But not as fun as you are!",
		"When you humans look up, you always think we look back. I only do that when it’s you",
		"The sky once called to me. I went. It was pretty cool. You are cooler, though.",
		"Don’t worry about it! Things break all the time. Like planets, stars and you~",
		"You shine brighter than any star I’ve seen!",
	...
	"Angry": [
		"Ridiculous… there’s no way you got that many",
	...
	"Dejected": [
		"Don’t think about it my love. Just play.",
		"Another globe gone then",
		"Stalling your round won’t change much",
		"There’s only so many rounds left for us to play",
